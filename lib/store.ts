...
interface AppStore { valuations: Valuation[]; isLoggedIn: boolean; analystEmail: string; setValuations:(v:Valuation[])=>void; addValuations:(v:Valuation[])=>void; login:(email:string)=>void; logout:()=>void; }
...
export const useStore = create<AppStore>()(persist((set,get)=>({
  valuations: DEMO, isLoggedIn: false, analystEmail: '',
