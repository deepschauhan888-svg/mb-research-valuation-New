...
export default function Home() {
  ...
  return (
    <>
      {/* ═══ HERO ═══ */}
      <section ref={heroRef} className="hero-dark" style={{ minHeight:"100svh", display:"flex", flexDirection:"column", justifyContent:"flex-end", paddingTop:"clamp(88px,10vh,140px)", paddingBottom:"clamp(112px,14vw,160px)", position:"relative" }}>
